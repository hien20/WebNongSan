        ...
        <div class="col-md-8">
            ...
            <div class="card p-3 mt-2">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="user d-flex flex-row align-items-center"> <img src="source/image/comment.png" width="30" class="user-img rounded-circle mr-2"> <span><large class="font-weight-bold text-primary">{{$name}}</large> <large class="font-weight-bold">{{$cmt->comment}}</large></span> </div> <small>{{$cmt->created_at}}</small>
                </div>
